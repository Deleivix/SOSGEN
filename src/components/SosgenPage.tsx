        ...
        try {
            ...
            resultsEl.querySelectorAll('.copy-btn').forEach(button => {
                button.addEventListener('click', (e) => {
                    ...
                    if(editableDiv) {
                        handleCopy(editableDiv.textContent || '');
                    }
                });
            });

            const finalSpanish = (resultsEl.querySelector('.editable-message') as HTMLElement)?.textContent || '';
            const finalEnglish = (resultsEl.querySelectorAll('.editable-message')[1] as HTMLElement)?.textContent || '';
